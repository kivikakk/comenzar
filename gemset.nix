{
  ...
  hanami-api = {
    ...
    source = {
      ...
      rev = "20f1072f84f37c394e4b0666f5f888eb9526b28d";
      sha256 = "1kf85gl17rb7xps2xsb4psp1z2hiyymvm0ngq74h96dn651whz4f";
      type = "git";
  ...
  hanami-router = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "05gp4hivwn3mlag3q9nqdmfxmvwy6cyji6wj4vvkiqmbs3d8jd74";
      type = "gem";
    };
    version = "2.0.1";
  };
